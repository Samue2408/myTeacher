<template>
  <main class="payment-page">
    ...
    <div v-else class="payment-layout">
      <section class="payment-form"><button class="back" @click="router.back()"><span class="material-icons-outlined">arrow_back</span> Volver al resumen</button><p class="eyebrow">Paso 3 de 3</p><h1>Finaliza tu pago</h1><p class="subtitle">Esta es una simulación: no se procesará ningún cobro real.</p>
